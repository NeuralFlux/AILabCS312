...
class TSP {
  ...
  public:
    ...
    void SimulatedAnnealing() {
        // Init Temp
        double TEMP_MAX = 50000000, TEMP_MIN = 0.5;
        double Temperature = TEMP_MAX;
        int max_iters = 1500, min_moves = 5;
	...
	vector<solution> PMX(solution parent1,solution parent2,int v1,int v2){
		...
		//assigning cities which are not between the crossover points for child1
		...
		//assigning cities which are not between the crossover points for child2
		for(int i=0; i<n_cities; i++){
			city a ;
			if(i < v1 || i > v2){
		...
		//assigning cities between the crossover points for child1
		for (int i = 0; i < n_cities; ++i)
		{
			int push = -1;
			if(i < v1 || i > v2){
		...
		//assigning cities between the crossover points for child2
		for (int i = 0; i < n_cities; ++i)
		{
			int push = -1;
			if(i < v1 || i > v2){
	...
	vector<solution> ordercrossover(solution parent1,solution parent2,int v1,int v2){
		...
		//assigning cities between the crossover points of parents as starting cities of child1 and child2
		for (int i = 0; i < n_cities; ++i)
		{
			if(i >v1-1 || i < v2+1){
		...
		//assigning cities which are not between the crossover points of parents for child1 and child2
		for (int i = 0; i < n_cities; ++i)
		{
			int ok = 0;
			int ok1 = 0;
